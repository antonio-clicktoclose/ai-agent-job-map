---
name: intelligence-analyst-notes
description: Turn a report into the actionable take. Binding happens in the prompt; the skill stays generic.
---

# intelligence / analyst notes

Turn a report into the actionable take.
