---
name: back-office-backup-watch
description: Verify backups exist and note the last check. Binding happens in the prompt; the skill stays generic.
---

# back office / backup watch

Verify backups exist and note the last check.
