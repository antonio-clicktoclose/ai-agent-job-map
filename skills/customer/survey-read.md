---
name: customer-survey-read
description: Summarize a survey into themes and actions. Binding happens in the prompt; the skill stays generic.
---

# customer / survey read

Summarize a survey into themes and actions.
