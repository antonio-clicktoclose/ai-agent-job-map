---
name: operations-project-plan
description: Break a project into steps, owners, and dates. Binding happens in the prompt; the skill stays generic.
---

# operations / project plan

Break a project into steps, owners, and dates.
