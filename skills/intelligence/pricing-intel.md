---
name: intelligence-pricing-intel
description: Gather pricing signals from the market. Binding happens in the prompt; the skill stays generic.
---

# intelligence / pricing intel

Gather pricing signals from the market.
