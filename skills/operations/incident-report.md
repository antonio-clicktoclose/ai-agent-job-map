---
name: operations-incident-report
description: Turn an incident into a clear postmortem. Binding happens in the prompt; the skill stays generic.
---

# operations / incident report

Turn an incident into a clear postmortem.
