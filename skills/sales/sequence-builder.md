...
description: Turn a target list into a multi-step outreach sequence. Binding happens in the prompt; the skill stays generic.
---

# sales / sequence builder

Turn a target list into a multi-step outreach sequence.
