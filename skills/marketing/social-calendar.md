---
name: marketing-social-calendar
description: Build a posting calendar from the content plan. Binding happens in the prompt; the skill stays generic.
---

# marketing / social calendar

Build a posting calendar from the content plan.
