---
name: deals-contract-flag
description: Flag contract terms that need a human review. Binding happens in the prompt; the skill stays generic.
---

# deals / contract flag

Flag contract terms that need a human review.
