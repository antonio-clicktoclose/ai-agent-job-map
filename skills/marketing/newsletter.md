...
description: Assemble a newsletter issue from this week's output. Binding happens in the prompt; the skill stays generic.
---

# marketing / newsletter

Assemble a newsletter issue from this week's output.
