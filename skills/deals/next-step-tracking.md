---
name: deals-next-step-tracking
description: Extract every promised next step and owner from a call. Binding happens in the prompt; the skill stays generic.
---

# deals / next step tracking

Extract every promised next step and owner from a call.
