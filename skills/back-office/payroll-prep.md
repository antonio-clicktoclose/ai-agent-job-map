---
name: back-office-payroll-prep
description: Prepare the payroll summary for review. Binding happens in the prompt; the skill stays generic.
---

# back office / payroll prep

Prepare the payroll summary for review.
