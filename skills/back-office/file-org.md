---
name: back-office-file-org
description: Organize a messy folder by a clear rule. Binding happens in the prompt; the skill stays generic.
---

# back office / file org

Organize a messy folder by a clear rule.
