---
name: operations-oncall-notes
description: Handover notes for a shift or a vacancy. Binding happens in the prompt; the skill stays generic.
---

# operations / oncall notes

Handover notes for a shift or a vacancy.
