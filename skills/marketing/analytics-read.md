---
name: marketing-analytics-read
description: Turn campaign numbers into a plain-language read. Binding happens in the prompt; the skill stays generic.
---

# marketing / analytics read

Turn campaign numbers into a plain-language read.
