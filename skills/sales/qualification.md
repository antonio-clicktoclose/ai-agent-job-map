...
description: Score a reply to decide if it is a real opportunity. Binding happens in the prompt; the skill stays generic.
---

# sales / qualification

Score a reply to decide if it is a real opportunity.
