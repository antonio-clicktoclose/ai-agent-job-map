---
name: sales-quota-tracking
description: Track each rep to quota from the pipeline data. Binding happens in the prompt; the skill stays generic.
---

# sales / quota tracking

Track each rep to quota from the pipeline data.
