---
name: operations-metrics-review
description: Weekly ops metrics with a plain-language read. Binding happens in the prompt; the skill stays generic.
---

# operations / metrics review

Weekly ops metrics with a plain-language read.
