---
name: operations-status-updates
description: Draft client status updates from work logs. Binding happens in the prompt; the skill stays generic.
---

# operations / status updates

Draft client status updates from work logs.
