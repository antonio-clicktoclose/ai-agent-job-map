---
name: sales-account-intel
description: Pack a one-page brief on a prospect before a call. Binding happens in the prompt; the skill stays generic.
---

# sales / account intel

Pack a one-page brief on a prospect before a call.
