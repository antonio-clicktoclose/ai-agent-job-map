---
name: operations-process-audit
description: Find where a process breaks and recommend a fix. Binding happens in the prompt; the skill stays generic.
---

# operations / process audit

Find where a process breaks and recommend a fix.
