---
name: operations-budget-track
description: Track actuals against a plan. Binding happens in the prompt; the skill stays generic.
---

# operations / budget track

Track actuals against a plan.
