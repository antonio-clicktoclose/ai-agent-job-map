---
name: back-office-tax-bucket
description: Bucket transactions for the accountant. Binding happens in the prompt; the skill stays generic.
---

# back office / tax bucket

Bucket transactions for the accountant.
