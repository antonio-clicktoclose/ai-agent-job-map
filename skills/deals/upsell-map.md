---
name: deals-upsell-map
description: Map natural upsell fits from current usage. Binding happens in the prompt; the skill stays generic.
---

# deals / upsell map

Map natural upsell fits from current usage.
