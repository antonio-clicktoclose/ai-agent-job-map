---
name: customer-upsell-signal
description: Flag accounts showing expansion signals. Binding happens in the prompt; the skill stays generic.
---

# customer / upsell signal

Flag accounts showing expansion signals.
