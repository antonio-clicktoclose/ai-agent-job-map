...
description: Draft a first proposal from the discovery notes. Binding happens in the prompt; the skill stays generic.
---

# sales / proposal drafting

Draft a first proposal from the discovery notes.
