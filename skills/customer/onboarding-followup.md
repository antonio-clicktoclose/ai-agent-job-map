---
name: customer-onboarding-followup
description: Follow up after onboarding with the next step. Binding happens in the prompt; the skill stays generic.
---

# customer / onboarding followup

Follow up after onboarding with the next step.
