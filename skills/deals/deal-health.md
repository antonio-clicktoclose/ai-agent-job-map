---
name: deals-deal-health
description: Score every open deal for risk and missing steps. Binding happens in the prompt; the skill stays generic.
---

# deals / deal health

Score every open deal for risk and missing steps.
