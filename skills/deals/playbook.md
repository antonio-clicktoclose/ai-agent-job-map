---
name: deals-playbook
description: Turn won deals into a repeatable closing playbook. Binding happens in the prompt; the skill stays generic.
---

# deals / playbook

Turn won deals into a repeatable closing playbook.
