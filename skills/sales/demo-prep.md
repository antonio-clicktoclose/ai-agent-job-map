...
description: Turn an account brief into a tailored demo plan. Binding happens in the prompt; the skill stays generic.
---

# sales / demo prep

Turn an account brief into a tailored demo plan.
