---
name: back-office-vendor-pay
description: Queue vendor payments with amounts and dates. Binding happens in the prompt; the skill stays generic.
---

# back office / vendor pay

Queue vendor payments with amounts and dates.
