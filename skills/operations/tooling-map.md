---
name: operations-tooling-map
description: Map your tools and what each one owns. Binding happens in the prompt; the skill stays generic.
---

# operations / tooling map

Map your tools and what each one owns.
