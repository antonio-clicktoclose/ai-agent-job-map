---
name: back-office-expense-triage
description: Categorize expenses from a feed. Binding happens in the prompt; the skill stays generic.
---

# back office / expense triage

Categorize expenses from a feed.
