---
name: deals-forecasting
description: Forecast likely closed revenue from current pipeline. Binding happens in the prompt; the skill stays generic.
---

# deals / forecasting

Forecast likely closed revenue from current pipeline.
