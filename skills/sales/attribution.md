...
description: Track which source produced each qualified opportunity. Binding happens in the prompt; the skill stays generic.
---

# sales / attribution

Track which source produced each qualified opportunity.
