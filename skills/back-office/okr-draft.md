---
name: back-office-okr-draft
description: Turn a goal into an OKR with owners. Binding happens in the prompt; the skill stays generic.
---

# back office / okr draft

Turn a goal into an OKR with owners.
