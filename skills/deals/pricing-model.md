---
name: deals-pricing-model
description: Model a pricing scenario before you quote. Binding happens in the prompt; the skill stays generic.
---

# deals / pricing model

Model a pricing scenario before you quote.
