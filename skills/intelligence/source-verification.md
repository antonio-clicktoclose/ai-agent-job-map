---
name: intelligence-source-verification
description: Verify a claim across sources. Binding happens in the prompt; the skill stays generic.
---

# intelligence / source verification

Verify a claim across sources.
