---
name: deals-closing-cta
description: Draft the close-focused CTA for each stage. Binding happens in the prompt; the skill stays generic.
---

# deals / closing cta

Draft the close-focused CTA for each stage.
