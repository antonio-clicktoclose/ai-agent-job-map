---
name: customer-community-nudge
description: Draft posts that keep a community active. Binding happens in the prompt; the skill stays generic.
---

# customer / community nudge

Draft posts that keep a community active.
