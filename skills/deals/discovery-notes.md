---
name: deals-discovery-notes
description: Turn a call recording into structured discovery notes. Binding happens in the prompt; the skill stays generic.
---

# deals / discovery notes

Turn a call recording into structured discovery notes.
