---
name: sales-counter-sequencing
description: Pause or change a sequence when a contact engages. Binding happens in the prompt; the skill stays generic.
---

# sales / counter sequencing

Pause or change a sequence when a contact engages.
