---
name: back-office-travel-plan
description: Plan a trip with dates, budget, and bookings. Binding happens in the prompt; the skill stays generic.
---

# back office / travel plan

Plan a trip with dates, budget, and bookings.
