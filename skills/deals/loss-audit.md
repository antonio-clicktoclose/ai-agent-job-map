---
name: deals-loss-audit
description: Summarize why lost deals went south. Binding happens in the prompt; the skill stays generic.
---

# deals / loss audit

Summarize why lost deals went south.
