---
name: back-office-invoice-draft
description: Draft an invoice from the work log. Binding happens in the prompt; the skill stays generic.
---

# back office / invoice draft

Draft an invoice from the work log.
