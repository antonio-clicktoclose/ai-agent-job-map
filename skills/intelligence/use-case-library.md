---
name: intelligence-use-case-library
description: Library of real use cases for your product. Binding happens in the prompt; the skill stays generic.
---

# intelligence / use case library

Library of real use cases for your product.
