...
description: Route voice-of-customer feedback to product. Binding happens in the prompt; the skill stays generic.
---

# customer / feedback loop

Route voice-of-customer feedback to product.
