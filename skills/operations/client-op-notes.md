---
name: operations-client-op-notes
description: Per-client operating notes that stay current. Binding happens in the prompt; the skill stays generic.
---

# operations / client op notes

Per-client operating notes that stay current.
