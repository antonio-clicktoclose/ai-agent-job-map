---
name: intelligence-watchlist
description: Maintain a watchlist with reasons to act. Binding happens in the prompt; the skill stays generic.
---

# intelligence / watchlist

Maintain a watchlist with reasons to act.
