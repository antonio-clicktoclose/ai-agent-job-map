---
name: customer-sla-tracking
description: Track tickets against response and resolve targets. Binding happens in the prompt; the skill stays generic.
---

# customer / sla tracking

Track tickets against response and resolve targets.
