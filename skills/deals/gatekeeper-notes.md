---
name: deals-gatekeeper-notes
description: Keep a running note on decision makers per account. Binding happens in the prompt; the skill stays generic.
---

# deals / gatekeeper notes

Keep a running note on decision makers per account.
