---
name: deals-renewal-nudge
description: Draft renewal outreach from contract dates. Binding happens in the prompt; the skill stays generic.
---

# deals / renewal nudge

Draft renewal outreach from contract dates.
