---
name: back-office-receipt-match
description: Match receipts to entries. Binding happens in the prompt; the skill stays generic.
---

# back office / receipt match

Match receipts to entries.
