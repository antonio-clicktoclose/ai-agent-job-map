---
name: back-office-policy-draft
description: Draft a policy from a set of rules. Binding happens in the prompt; the skill stays generic.
---

# back office / policy draft

Draft a policy from a set of rules.
