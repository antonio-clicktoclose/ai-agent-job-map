...
description: Extract usable testimonials from customer feedback. Binding happens in the prompt; the skill stays generic.
---

# marketing / testimonial

Extract usable testimonials from customer feedback.
