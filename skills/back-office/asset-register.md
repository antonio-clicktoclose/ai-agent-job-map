---
name: back-office-asset-register
description: Registry of company assets and status. Binding happens in the prompt; the skill stays generic.
---

# back office / asset register

Registry of company assets and status.
