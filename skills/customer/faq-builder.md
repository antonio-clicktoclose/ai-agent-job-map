---
name: customer-faq-builder
description: Build a FAQ from real questions. Binding happens in the prompt; the skill stays generic.
---

# customer / faq builder

Build a FAQ from real questions.
