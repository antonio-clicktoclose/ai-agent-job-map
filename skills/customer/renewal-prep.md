---
name: customer-renewal-prep
description: Prepare the renewal conversation with their usage. Binding happens in the prompt; the skill stays generic.
---

# customer / renewal prep

Prepare the renewal conversation with their usage.
