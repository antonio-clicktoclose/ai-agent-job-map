---
name: customer-churn-interview
description: Prepare questions for an at-risk account. Binding happens in the prompt; the skill stays generic.
---

# customer / churn interview

Prepare questions for an at-risk account.
