---
name: sales-a-b-messaging
description: Compare two outreach variants from reply data. Binding happens in the prompt; the skill stays generic.
---

# sales / a b messaging

Compare two outreach variants from reply data.
