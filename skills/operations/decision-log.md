---
name: operations-decision-log
description: Log decisions and the reasons behind them. Binding happens in the prompt; the skill stays generic.
---

# operations / decision log

Log decisions and the reasons behind them.
