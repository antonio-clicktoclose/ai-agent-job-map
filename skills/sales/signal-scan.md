---
name: sales-signal-scan
description: Watch for buying signals in a feed of accounts. Binding happens in the prompt; the skill stays generic.
---

# sales / signal scan

Watch for buying signals in a feed of accounts.
