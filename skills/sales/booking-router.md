---
name: sales-booking-router
description: Route and book qualified conversations on a calendar. Binding happens in the prompt; the skill stays generic.
---

# sales / booking router

Route and book qualified conversations on a calendar.
