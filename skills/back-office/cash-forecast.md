---
name: back-office-cash-forecast
description: Forecast cash from known inflows and outflows. Binding happens in the prompt; the skill stays generic.
---

# back office / cash forecast

Forecast cash from known inflows and outflows.
