...
description: Enforce a consistent brand voice across drafts. Binding happens in the prompt; the skill stays generic.
---

# marketing / brand voice

Enforce a consistent brand voice across drafts.
