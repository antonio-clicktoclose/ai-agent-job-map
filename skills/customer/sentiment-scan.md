---
name: customer-sentiment-scan
description: Scan messages for frustration and blockers. Binding happens in the prompt; the skill stays generic.
---

# customer / sentiment scan

Scan messages for frustration and blockers.
