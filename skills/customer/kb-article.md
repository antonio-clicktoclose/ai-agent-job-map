---
name: customer-kb-article
description: Turn resolved tickets into help articles. Binding happens in the prompt; the skill stays generic.
---

# customer / kb article

Turn resolved tickets into help articles.
